    ...
    <div className="min-h-screen bg-transparent">
      ...
      <section className="container mx-auto px-4 pb-6 pt-8 text-center sm:pb-10 sm:pt-14 lg:pb-14 lg:pt-18">
        <div className="mx-auto max-w-4xl">
          <div className="mb-5 inline-flex rounded-full border border-amber-500/25 bg-amber-500/8 px-4 py-2 shadow-sm">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-base leading-relaxed text-white/55 sm:text-lg">
          ...
          <div className="grid gap-3 sm:grid-cols-3 sm:gap-4">
            <div className="rounded-2xl border border-blue-500/15 bg-white/[0.04] px-4 py-4 shadow-sm">
              <span className="mb-2 block text-lg text-blue-400">🛡️</span>
              <span className="text-sm font-semibold text-white/80">Licenciado pelo SRIJ</span>
            </div>
            <div className="rounded-2xl border border-blue-500/15 bg-white/[0.04] px-4 py-4 shadow-sm">
              <span className="mb-2 block text-lg text-blue-400">⭐</span>
              <span className="text-sm font-semibold text-white/80">Avaliações Independentes</span>
            </div>
            <div className="rounded-2xl border border-blue-500/15 bg-white/[0.04] px-4 py-4 shadow-sm">
              <span className="mb-2 block text-lg text-blue-400">🔒</span>
              <span className="text-sm font-semibold text-white/80">Informação Segura</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="casinos" className="container mx-auto px-4 pb-16">
        <div className="mb-5 text-center sm:mb-8">
          <h2 className="mb-2 text-xl font-extrabold tracking-wide text-blue-400 sm:mb-3 sm:text-2xl lg:text-3xl">
        ...
        <div className="mx-auto mt-8 max-w-2xl rounded-2xl border border-blue-500/10 bg-white/[0.03] p-3 shadow-sm sm:mt-10 sm:p-4">
      ...
      {/* About Section */}
      <section id="sobre" className="border-y border-blue-500/8 bg-black/20 py-10 sm:py-14 lg:py-18">
        <div className="container mx-auto max-w-5xl px-4">
          ...
          <div className="mb-6 rounded-2xl border border-blue-500/10 bg-white/[0.04] p-5 shadow-sm sm:mb-8 sm:p-7 lg:p-8">
          ...
          <div className="mb-6 rounded-2xl border border-blue-500/10 bg-white/[0.04] p-5 shadow-sm sm:mb-8 sm:p-7 lg:p-8">
            ...
            <p className="mt-4 text-xs italic text-white/40 sm:text-sm">
          ...
          <div className="mb-6 rounded-2xl border border-blue-500/10 bg-white/[0.04] p-5 shadow-sm sm:mb-8 sm:p-7 lg:p-8">
            ...
            <p className="mb-3 text-sm leading-relaxed text-white/60 sm:text-base">
          ...
          <div id="responsabilidade" className="mb-6 rounded-2xl border border-amber-500/15 bg-[linear-gradient(135deg,rgba(11,18,34,0.96),rgba(20,30,55,0.96))] p-5 shadow-lg sm:mb-8 sm:p-7 lg:p-8">
          ...
          {/* Regular Info Update */}
          <div className="rounded-2xl border border-blue-500/10 bg-white/[0.04] p-5 shadow-sm sm:p-7 lg:p-8">
            <h3 className="mb-4 text-lg font-bold text-white sm:text-xl">
      ...
      <section className="py-10 sm:py-14 lg:py-18">
        <div className="container mx-auto max-w-5xl px-4">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-center text-sm text-white/45 sm:mb-10 sm:text-base">
      ...
      {/* Cookies notice */}
      <section id="cookies" className="border-t border-blue-500/8 bg-black/15 py-8 sm:py-10">
        <div className="container mx-auto max-w-4xl px-4">
          <h3 className="mb-4 text-center text-lg font-bold text-white sm:text-xl">
            Utilização de Cookies
          </h3>
          <p className="mx-auto max-w-2xl text-center text-xs leading-relaxed text-white/50 sm:text-sm">
