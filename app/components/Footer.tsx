...
export default function Footer() {
  ...
  return (
    <footer id="contacto" className="border-t border-white/[0.05] bg-[#050810] py-8 sm:py-12 lg:py-16">
      <div className="container mx-auto max-w-6xl px-4">
        <div className="mb-8 flex justify-center sm:mb-10">
          <Logo className="rounded-full border border-sky-500/10 bg-white/[0.025] px-4 py-2" />
        </div>
        ...
        <div id="responsabilidade" className="mb-8 rounded-2xl border border-rose-500/10 bg-rose-500/[0.03] p-5 sm:mb-10 sm:p-6">
          <h5 className="mb-3 text-center text-sm font-bold uppercase tracking-wider text-rose-400">
            Jogo Responsável
          </h5>
        ...
        <nav className="mb-8 flex flex-wrap items-center justify-center gap-x-5 gap-y-2 sm:mb-10 sm:gap-x-6">
          {navLinks.map((link, i) => (
            <span key={link.name} className="flex items-center gap-5 sm:gap-6">
              <a
                href={link.href}
                className="text-xs font-medium text-white/40 transition-colors hover:text-sky-400 sm:text-sm"
              >
                {link.name}
              </a>
              {i < navLinks.length - 1 && (
        ...
        <div className="mb-8 flex items-center justify-center gap-5 sm:mb-10">
          <a
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full border border-white/[0.07] bg-white/[0.03] text-white/40 transition-colors hover:border-sky-500/25 hover:text-sky-400"
            aria-label="Facebook"
          >
        ...
        <div className="mb-8 flex flex-wrap items-center justify-center gap-6 sm:mb-10 sm:gap-10">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center rounded-2xl border border-white/[0.06] bg-white/[0.025] px-5 py-3 transition-colors hover:border-sky-500/20"
          ...
          >
            <svg viewBox="0 0 200 50" xmlns="http://www.w3.org/2000/svg" className="h-10 w-auto sm:h-12">
              ...
              <text x="100" y="22" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="15" fontWeight="800" fill="#0ea5e9">JOGO</text>
